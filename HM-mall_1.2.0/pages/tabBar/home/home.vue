	...
	<view>
		...
		<view class="goods-list">
			...
			<view class="product-list">
				<view
					class="product"
					v-for="sr in [likeList[0],likeList[1]]"
					:key="sr.srid"
					@tap="toStudyroom(sr.srid)"
				>
					<image src="../../../static/img/c1.jpg"></image>
					<view class="info">
						<view class="name">{{ sr.srname }}</view>
						<view class="price">{{ sr.price }}/天</view>
					</view>
				</view>
				<view
					class="product"
					v-for="office in [likeListOffice[0],likeListOffice[1]]"
					:key="office.officeid+1000"
					@tap="toOffice(office.officeid)"
				>
					<image src="../../../static/img/c2.jpg"></image>
					<view class="info">
						<view class="name">{{ office.officename }}</view>
						<view class="price">{{ office.price }}/月</view>
					</view>
				</view>
			</view>
			<!-- <view class="loading-text">{{ loadingText }}</view> -->
			<navigator url="/pages/tabBar/findhome/findhome" open-type="switchTab" hover-class="other-navigator-hover">
			    <button type="primary" class="clickmore">点击查看更多</button>
			</navigator>
...
export default {
	data() {
		return {
			...
			// 轮播图片
			swiperList: [
				{ id: 1, src: 'url1', img: '/static/img/c1.jpg' },
				{ id: 2, src: 'url2', img: '/static/img/c2.jpg' },
				{ id: 3, src: 'url3', img: '/static/img/c3.jpg' }
			],
			// 分类菜单
			categoryList: [
				{ id: 1, name: '北京', img: '/static/img/category/city.png' },
				{ id: 2, name: '上海', img: '/static/img/category/city.png' },
				{ id: 3, name: '广州', img: '/static/img/category/city.png' },
				{ id: 4, name: '深圳', img: '/static/img/category/city.png' },
				{ id: 5, name: '成都', img: '/static/img/category/city.png' },
				{ id: 6, name: '重庆', img: '/static/img/category/city.png' },
				{ id: 7, name: '武汉', img: '/static/img/category/city.png' },
				{ id: 8, name: '杭州', img: '/static/img/category/city.png' }
			],
			Promotion: [],
			//猜你喜欢列表
			likeList:{},
	...
	onLoad() {
		uni.request({
		    url: 'http://zy.eatclub.wang:3000/list/sr', //仅为示例，并非真实接口地址。
		    method: 'GET',  
		    data: {},  
		    success: res => {  
		...
		uni.request({
		    url: 'http://zy.eatclub.wang:3000/list/office', //仅为示例，并非真实接口地址。
		    method: 'GET',  
		    data: {},  
		    success: res => {  
				this.likeListOffice = res.data.data;
		    },  
		    fail: () => {},  
		    complete: () => {}
		});
		...
		this.amapPlugin = new amap.AMapWX({
			...
			key: '3ef137506182cf7ca6cd3e2cee9daf31'
		});
		// 定位地址
